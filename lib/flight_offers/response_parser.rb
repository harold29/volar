module FlightOffers
  class ResponseParser # rubocop:disable Metrics/ClassLength
    ...
    def flight_offer_params(flight_offer_data)
      {
        ...
        pricing_options_fare_type: flight_offer_data[:pricing_options][:fare_type],
        pricing_options_included_checked_bags_only: flight_offer_data[:pricing_options][:included_checked_bags_only],
        pricing_options_refundable_fare: flight_offer_data[:pricing_options][:refundable_fare],
        pricing_options_no_restriction_fare: flight_offer_data[:pricing_options][:no_restriction_fare],
        pricing_options_no_penalty_fare: flight_offer_data[:pricing_options][:no_penalty_fare],
        validating_airline_codes: flight_offer_data[:validating_airline_codes],
